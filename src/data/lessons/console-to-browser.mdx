...
In other words, the browser provides an API in the form of a `document` object that **models the HTML document as a tree of objects**. When we talk about "the DOM", we're talking about this object-based representation of the page that JavaScript can read and update.
