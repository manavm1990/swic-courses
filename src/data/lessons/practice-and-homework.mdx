...
let favNumberSquared = favoriteNumber * favoriteNumber;
...
let difference = Math.abs(num1 - num2); // Absolute difference
...
// String combinations
let combinedSentence = sentence1 + " and " + sentence2;
let modifiedSentence = sentence1.replace("powerful", word1);
let personalStatement = "I am becoming an " + word1 + " " + word2;
...
let name = John;  // ❌ Error teaches importance of string syntax
...
let person;
console.log(person.name); // ❌ Error teaches checking for undefined
