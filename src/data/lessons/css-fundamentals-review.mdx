...
Build a responsive "About Me" page that includes:

- A header with your name and navigation links
- A hero section with your photo and brief bio
- A skills section with a grid of skill cards
- A contact section with social media links

**Requirements:**

- Use Flexbox for the header navigation and contact links
- Use Grid for the skills section
