...
**⚠️:** The code snippets in this lesson are for Demonstrating concepts. This means that the code as is may not pass linting, which is more strict. It will be your job to ensure your version of the code passes linting.
