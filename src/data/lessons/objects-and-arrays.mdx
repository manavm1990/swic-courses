...
**Important**: Before diving into objects and arrays, you'll need your development environment.

### 1. Get Your Assignment Template From BrightSpace

You probably came here from that assignment link, so no worries there. Just make sure that you have accepted the GitHub Classroom assignment and have your repository ready.

This gives you a personalized copy of our Node.js template with ESLint and proper project structure.
...
As indicated, "Hands On" is where you will be required to start writing code and making commits. However, you may wish to code the 'basics' examples also for additional practice.
