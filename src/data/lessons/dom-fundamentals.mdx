...
<div class="card bg-white p-4 rounded shadow">
  <h3>Card Title</h3>
  <button class="btn bg-blue-500 text-white px-4 py-2 rounded">Click me</button>
</div>
```
...
```html
<div>
  <p>Hello world</p>  <!-- Browser auto-closes the tag -->
</div>
```
...
### Assignment 2: Template Repository Setup
...
4. **Modify the template** to create a simple "About Me" page with:
...
**Deliverable**: Push your completed project to GitHub and submit the repository link.

### Assignment 3: DOM Reflection
**Goal**: Personal reflection on understanding the DOM and its role in web development.
...
**Format**: Write conversationally, use examples from your experience, and be honest about what's still confusing.

**Deliverable**: Submit `dom-reflection.md` file.

## Key Differences: HTML vs DOM

| HTML Source Code | DOM (What Browser Creates) |
|-----------------|---------------------------|
| Static text file | Live JavaScript objects |
| May have errors | Browser fixes errors |
| Fixed structure | Can be modified by JavaScript |
| What you write | What the browser works with |

### Example of Browser Auto-Correction
**Your HTML:**
```html
<div>
...
```html
<div>
  <p>Unclosed paragraph</p>  <!-- Browser closes it -->
  <div>Another div</div>
</div>
```
...
- [Chrome DevTools: View and change the DOM](https://developers.google.com/web/tools/chrome-devtools/dom)